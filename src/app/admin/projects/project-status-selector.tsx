  ...
  return (
    <SingleBadgeSelector
      options={[
        {
          value: "NOTSTART",
          label: () => <Badge className="bg-neutral-200">ยังไม่เริ่ม</Badge>,
        },
        {
          value: "INPROGRESS",
          label: () => <Badge className="bg-yellow-200">ดำเนินอยู่</Badge>,
        },
        {
          value: "COMPLETE",
          label: () => <Badge className="bg-green-200">เสร็จสิ้น</Badge>,
        },
        {
          value: "EVALUATE",
          label: () => <Badge className="bg-blue-200">กำลังประเมิน</Badge>,
        },
      ]}
      onValueChange={async (newStatus) => {
        try {
          await setProjectStatus.mutateAsync({
            projectId,
